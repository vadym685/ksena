...
create table KSENA_COMPANY (
    ...
    FIELD_OF_ACTIVITY_ID varchar(36),
...
create table KSENA_TASK (
    ...
    KIND_OF_CLEANING_ID varchar(36),
    COST_OF_DELIVERY double precision,
    RESPONSIBLE_FOR_THE_DELIVERY_OF_INVENTORY_ID varchar(36),
    TIME_FOR_START_COMPLETION time,
    COMMENT varchar(255),
    CLIENT_COMMENT varchar(255),
    PLANNED_CLEANING_VOLUME double precision,
    ACTUAL_CLEANING_VOLUME double precision,
...
create table KSENA_CLIENT_EMPLOYEE_POINT_LINK (
    ...
    primary key (CLIENT_EMPLOYEE_ID, POINT_ID)
)^
...
create table KSENA_CLEANING_POSITION_EXPENDABLE_MATERIAL_LINK (
    ...
    primary key (CLEANING_POSITION_ID, EXPENDABLE_MATERIAL_ID)
)^
